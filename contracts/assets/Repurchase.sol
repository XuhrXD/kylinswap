...
contract Repurchase is Ownable {
    ...
    address public constant KYI = 0x25D2e80cB6B86881Fd7e07dd263Fb79f4AbE033c;
    address public constant KYI_USDT = 0x615E6285c5944540fd8bd921c9c8c56739Fd1E13;
    ...
    function swap() external onlyCaller returns (uint256 amountOut){
        ...
        (uint256 reserve0, uint256 reserve1,) = IKyiPair(KYI_USDT).getReserves();
        uint256 amountInWithFee = amountIn.mul(997);
        amountOut = amountIn.mul(997).mul(reserve0) / reserve1.mul(1000).add(amountInWithFee);
        IERC20(USDT).safeTransfer(KYI_USDT, amountIn);
        IKyiPair(KYI_USDT).swap(amountOut, 0, destroyAddress, new bytes(0));
    }
